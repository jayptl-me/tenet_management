...
const navItems: NavItem[] = [
  ...
  { href: '/meals', label: 'Meals', icon: <Utensils className="h-5 w-5" /> },
  ...
  { href: '/notices', label: 'Notices', icon: <Megaphone className="h-5 w-5" /> },
  { href: '/visitors', label: 'Visitors', icon: <DoorOpen className="h-5 w-5" /> },
  {
    href: '/guardians',
    label: 'Guardians',
