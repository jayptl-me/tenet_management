...
function buildCommands(
  ...
  return [
    ...
    },
    {
      ...
      keywords: ['wash', 'machines', 'dryer', 'timer', 'laundry'],
      icon: Shirt,
      featureFlag: 'laundryEnabled',
    },
    {
    ...
    // Create
    {
      ...
      category: 'Create',
      href: '/tenants/new',
      keywords: ['add', 'new', 'onboard', 'resident'],
      icon: Users,
    },
    {
      id: 'create-room',
      ...
      category: 'Create',
      href: '/rooms/new',
      keywords: ['add', 'bed', 'accommodation'],
      icon: BedDouble,
    },
    {
      id: 'create-floor',
    ...
    },
    {
      ...
      category: 'Create',
      href: '/payments/new',
      keywords: ['offline', 'cash', 'upi', 'collect'],
      icon: CreditCard,
    },
    {
      id: 'create-notice',
      ...
      category: 'Create',
      href: '/notices/new',
      keywords: ['announcement', 'broadcast', 'post'],
      icon: Megaphone,
      featureFlag: 'noticeBoardEnabled',
    },
    {
    ...
    },
    {
      ...
      category: 'Create',
      href: '/services/new',
      keywords: ['amenity', 'facility', 'wifi'],
      icon: Wifi,
    },
    {
      id: 'create-asset',
      ...
      category: 'Create',
      href: '/assets/new',
      keywords: ['inventory', 'item', 'equipment'],
      icon: Package,
    },
    {
      id: 'create-guardian',
    ...
    },
    {
      ...
      category: 'Create',
      href: '/visitors/new',
      keywords: ['guest', 'entry', 'checkin'],
      icon: DoorOpen,
      featureFlag: 'visitorManagementEnabled',
    },
    {
      id: 'create-menu',
      label: 'New Daily Menu',
      category: 'Create',
      href: '/menus/new',
      keywords: ['food', 'breakfast', 'lunch', 'dinner'],
      icon: Utensils,
    },
    {
      id: 'create-meal',
    ...
    },
    {
      ...
      category: 'Create',
      href: '/laundry/new',
      keywords: ['wash', 'cloth', 'clothes'],
      icon: Shirt,
      featureFlag: 'laundryEnabled',
    },
    {
      id: 'create-washing-machine',
      label: 'New Washing Machine',
      category: 'Create',
      href: '/washing-machines/new',
      keywords: ['appliance', 'washer', 'dryer'],
      icon: Shirt,
      featureFlag: 'laundryEnabled',
    },
    {
      id: 'create-electricity',
      label: 'New Electricity Reading',
      category: 'Create',
      href: '/electricity/new',
      keywords: ['meter', 'units', 'power'],
      icon: Zap,
    },
    {
    ...
    },
    {
      ...
      category: 'Create',
      href: '/leaves/new',
      keywords: ['vacation', 'absence', 'time off'],
      icon: CalendarClock,
      featureFlag: 'attendanceEnabled',
    },
    {
