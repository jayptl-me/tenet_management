  ...
  return (
    <div className="animate-fade-in-up space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="font-[family:var(--font-display)] text-[color:var(--color-text-primary)] text-2xl font-extrabold">Edit Guardian</h2>
          <p className="text-[color:var(--color-text-muted)] mt-0.5 text-sm">Update guardian details</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="rounded-lg border-[length:var(--bw-strong)] border-[color:var(--border-color)] bg-[color:var(--color-surface-100)] p-6 shadow-[var(--shadow-card)]">
        <div className="space-y-5">
          ...
          <label className="flex items-center gap-2">
            ...
            <span className="text-[color:var(--color-text-primary)] text-sm font-semibold">Emergency Contact</span>
          </label>
          <label className="flex items-center gap-2">
