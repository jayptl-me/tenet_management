  ...
  return (
    <div className="animate-fade-in-up space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="font-display text-surface-900 text-2xl font-extrabold">Edit Meal Feedback</h2>
          <p className="text-surface-500 mt-0.5 text-sm">Update meal feedback details</p>
        </div>
      </div>
