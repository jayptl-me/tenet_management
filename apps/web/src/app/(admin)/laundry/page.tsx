  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
        <div>
          <h2 className="font-display text-surface-900 text-2xl font-extrabold">Laundry Slots</h2>
          <p className="text-surface-500 mt-0.5 text-sm">Manage laundry slot bookings</p>
        </div>
